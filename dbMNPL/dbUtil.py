...
from streamlit import secrets, cache_data as stCache, cache_resource
...
@cache_resource(hash_funcs={"_thread.RLock":lambda _:None, "builtins.weakref":lambda _:None})
